...
import org.booleanull.core_ui.command.AnimateForward
import org.booleanull.core_ui.command.SharedViewForward
...
class Router(
    private val navigationDeepLinkHandler: NavigationDeepLinkHandler
) : BaseRouter() {
